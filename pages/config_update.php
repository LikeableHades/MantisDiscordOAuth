...
form_security_validate( 'plugin_DiscordOauth_config_update' );
auth_reauthenticate( );
...
plugin_config_set( 'userData',gpc_get_int( 'prefUserData', ON ) );
...
form_security_purge( 'plugin_DiscordOauth_config_update' );
